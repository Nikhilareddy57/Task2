...
{ //cout <<myVector[i].color<<" ";
    //    cout << color_RGB(  )[0] << " " << color_RGB( myVector[i].color )[1] << " " << color_RGB( myVector[i].color )[2] << "\n"; 
        string color = myVector[i].color;
        float fact1 = roadLength/2, fact2 = 2*roadWidth;
        //vector<float> color = color_RGB( myVector[i].color);
